      ...
      >
        <div className="relative w-60 bg-opacity-50 pointer-events-none aspect-[896/1831]">
          <AspectRatio
            ratio={896 / 1831}
            ref={phoneCaseRef}
            className="pinter-events-none relative z-50 aspect-[896/1831] w-full"
          >
            <NextImage
              fill
              alt="phone image"
          ...
          rounded-[32px] shadow-[0_0_0_99999px_rgba(229, 231, 235, 0.6)] bottom-px"
          />
          <div
            className={cn(
                      ...
                      <div className="mt-3 space-y-4">
                        {selectableOptions.map((option) => (
                          ...
                          >
                            ...
                            <RadioGroup.Description
                              as="span"
                              className="mt-2 flex text-sm sm:ml-4 sm:flex-col sm:text-right"
                            >
